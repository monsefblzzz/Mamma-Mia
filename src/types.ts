...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { id: 'pp4', name: 'Pepperoni', description: 'Tomate, mozzarella y pepperoni', price: 11.00, category: 'Pizzas', image: '/img/PEPPERONI.jpg' },
  ...
  { id: 'mp3', name: 'Prosciutto', description: 'Tomate, mozzarella y jamón york', price: 9.50, category: 'Pizzas', image: '/img/PROSCIUTTO.jpg' },
  ...
  { id: 'mp9', name: 'Vegetal', description: 'Tomate, mozzarella y verduras asadas y pétalos de sal negra', price: 11.50, category: 'Pizzas', image: '/img/VEGETAL.jpg' },
  ...
  { id: 'mp17', name: 'Prosciutto Funghi', description: 'Tomate, mozzarella, jamón york y champiñones', price: 10.00, category: 'Pizzas', image: '/img/PROSCIUTTOFUNGHI.jpg' },
  ...
  { id: 'mp24', name: 'Pesto y Burrata', description: 'Tomate, pesto genovés, burrata y tomates cherry', price: 14.50, category: 'Pizzas', image: '/img/PESTOBURRATA.jpg' },

  // HAMBURGUESAS
  { id: 'h1', name: 'Rubia', description: 'Hamburguesa vaca rubia gallega (130g), pulled pork, queso cheddar, cebolla caramelizada y brotes tiernos', price: 15.00, category: 'Hamburguesas', image: '/img/RUBIA.jpg' },
  ...
  { id: 'h3', name: 'Xtrem', description: 'Hamburguesa ternera (100g), queso, bacon, cebolla, huevo, tomate y brotes tiernos', price: 10.50, category: 'Hamburguesas', image: '/img/XTREM.jpg' },
  ...
  // MENÚ THE BOX
  { id: 'box1', name: 'Menú "The Box"', description: 'Pizza + Patatas + Aperitivo 1/2 Ración + Bebida', price: 13.50, category: 'Menús Especiales', image: '/img/THEBOX.jpg' },
  ...
  { id: 'sprite_lata', name: 'Sprite (Lata)', description: 'Lata de Sprite de 33cl', price: 2.00, category: 'Bebidas', image: '/img/sprite.jpg' },
  ...
  // POSTRES
  { id: 'pistamisu', name: 'Pistamisu', description: 'Tiramisú de pistacho suave, cremoso y casero', price: 6.50, category: 'Postres', tags: ['Novedad'], image: '/img/PISTAMISU.jpg' },
  ...
  { id: 'bj_pecan_blondie', name: "Vanilla Pecan Blondie (Ben & Jerry's)", description: "Helado de vainilla con trozos de brownie rubio rubio y caramelo salado", price: 7.50, category: 'Postres', image: '/img/VAINILLAPECAN.jpg' },
